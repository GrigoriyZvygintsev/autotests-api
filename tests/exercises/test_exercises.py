...
class TestExercises:
    ...
    def test_get_exercise(
        ...
        id_exercise = function_exercise.response.exercise.id
        response = exercises_client.get_exercise_api(id_exercise)
        response_data = GetExerciseResponseSchema.model_validate_json(response.text)
    ...
    def test_get_exercises(
        ...
        for _ in range(2):
            ...
            extra_response = exercises_client.create_exercise(extra_request)
            expected_exercises.append(extra_response)
