...
def assert_get_file_with_incorrect_file_id_response(actual: ValidationErrorResponseSchema):
    """
    Убеждаемся, что ответ для некорректного `file_id` содержит ожидаемую ошибку парсинга UUID.

    :param actual: Ответ API на запрос с некорректным `file_id`, распарсенный в ValidationErrorResponseSchema.
    :raises AssertionError: Если ответ не совпадает с ожидаемой валидационной ошибкой.
    """
